...
const String TITLE_SING_UP = "Sing Up";
const String SING_UP_DOCTOR = "sing up as doctor";
const String SING_UP_PERSON = "sing up as person";
const String FNAME = "First Name";
const String PHONE_NUMBER = "phone number";
const String LNAME = "Last Name";
const String COUNTRY = "your country";
const String COUNTRYC = "your country Clinic";
const String CITY = "your city";
const String CITYC = "your city Clinic";
const String REGOIN = "your regoin";
const String REGOINC = "your regoin clinic";
const String FLAT_NUMBER = "your flat number";
const String SYNDICALISMNUMBER = "your syndicalism number";
const String ID_PERSON = "enter your id";
const String BIRTH_DATE = "enter your birthdate";
